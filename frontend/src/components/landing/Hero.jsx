        ...
        <div className="grid lg:grid-template-columns-[1.2fr_1fr] gap-16 items-center">
          ...
          >
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-600 font-bold text-sm mb-8"
            >
              <Sparkles size={16} />
            ...
            >
              AgentX is the control room for your AI sales team. Track reasoning, 
              orchestrate meetings, and generate structured insights in real-time.
            </motion.p>
            ...
            >
              <div className="flex flex-col">
                ...
                <span className="text-sm text-slate-500 uppercase tracking-wider font-bold">Accuracy</span>
              </div>
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-slate-900">2.4x</span>
                <span className="text-sm text-slate-500 uppercase tracking-wider font-bold">Deal Velocity</span>
              </div>
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-slate-900">10k+</span>
                <span className="text-sm text-slate-500 uppercase tracking-wider font-bold">Meetings Run</span>
              </div>
            </motion.div>
          </motion.div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Current Thought</span>
                    <span className="text-[10px] font-black text-indigo-600">94% Confidence</span>
                  </div>
                  ...
                  <p className="text-sm font-medium text-slate-700">"Analyzing customer's objection regarding budget. Preparing value-based counter-argument..."</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-indigo-600 rounded-2xl text-white shadow-xl shadow-indigo-200">
                    ...
                    <div className="text-[10px] font-bold opacity-60 uppercase mb-1">Risk Found</div>
                    <div className="text-sm font-bold">Dependency Lock-in</div>
                  </div>
                  <div className="p-4 bg-white rounded-2xl border border-slate-100">
                    <Sparkles size={24} className="mb-3 text-amber-500" />
                    <div className="text-[10px] font-bold text-slate-400 uppercase mb-1">Suggestion</div>
                    <div className="text-sm font-bold text-slate-800 italic">"Offer Tier 2 trial"</div>
                  </div>
                </div>
              </div>
            </div>
