      ...
      <div className="px-6 mb-8">
        <div className="p-5 bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-3xl relative overflow-hidden group cursor-pointer">
          <div className="relative z-10">
            ...
            <div className="text-white font-black text-sm mb-1 leading-tight">Scale your reach <br />with AgentX Pro</div>
            <div className="text-[10px] text-white/60 font-medium">Upgrade now for 2.4x velocity</div>
          </div>
      ...
      <div className="p-6 border-t border-white/5">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-white truncate">{user?.name || 'Sales Expert'}</p>
            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest truncate">Revenue Team</p>
          </div>
        </div>
      </div>
    </aside>
